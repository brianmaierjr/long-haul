...
Finally, we can see that whereas banks, firms and the government are net debtors, households and the foreign economy are net creditors in Brazil's macroeconomci system.


we can see the sectoral balance sheet relations but we can't, yet, define in which instruments each sector finace their expenditures, and in which instrumetns they hold financial assets. This is illustrated on Figure 5, below:
