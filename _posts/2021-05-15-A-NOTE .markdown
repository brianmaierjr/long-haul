...
Economic models have different purposes. One of them is designing economic policies. Given that economic models are often a mathematical framework, they can provide numerical estimates of policy options. And often they do are used by government departments, such as Central Banks, to base policy-decisions.
...
But is money, or any other financial instruction, irrelevant for understanding business cycles?
...
In 2008, for instance, we could see the perverse effect of a serious economic crisis, of international scale, whose effects on economic activity were felt for years.

So why did "nobody see this coming"?

The workhorse of current neoclassical macroeconomics are DSGE models. In this framework, events such as economic crisis, when not ruled out by construction, are exogenous shocks, and not breeded withing the economic system. Albeit seemingly sophisticated, DSGE models could not foresee the 2008 crisis, I support, due to the lack of a proper integration of finance into economic modelling.
...
It is possible to see a strong correlation between the two series both in upward and downward economic cycles. Although not conclusive, this exemplifies the potential drawback of omitting the real-financial nexus on macroeconomic modelling.
...
In other words, financing is created endogenously by the financial system. This has a double implication for the economic system. At the same time that agents can lend more than they can pay back, banks can lend beyond the safe level. That is, financial imbalances are created within the economic system..
