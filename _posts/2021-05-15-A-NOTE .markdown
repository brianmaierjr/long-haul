...
Economic models have different purposes. One of them is designing economic policies. Given that economic models are often a mathematical framework, they can provide numerical estimates of policy options. And often they do are used by government departments, such as the Central Bank, to base policy-decisions.


Some real world problems, however, are often neglected by the standard economic theory, which is know as neoclassical economics. One of these problems is the role of finance on economic dynamics. Financial markets include several agents and instruments. Apart from the stock market, the creation of credit by banks, the issue of bonds by national treasuries, and even interest-beargin deposits, are all part of the financial system. Notwishstanding, most of these elements are absent in the mainstream macroeconomic modelling, specially in cycles and growth analysis.
...
We can see both that banking crisis are a natural element of the economic system - being observed since the 19th century - but also that they frequency increased significantly, becoming increasingly more frequent during the past 40 years, when the Bretton Woods agreement came to an end. 


In 2008, for instance. we could see the remarkable influence of financial markets in the whole economic system, affecting production, employment, and several other 'real' elements of the economy for years.



So why "nobody saw it coming"? 

The workhorse of current neoclassical macroeconomics are DSGE models. In this framework, events such as economic crisis, when not ruled out by construction, are exogenous shocks, and not breeded withing the economic system. 
