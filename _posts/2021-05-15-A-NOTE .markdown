...
We nonfinancial firms' debt grows higher that its average before recessive periods. This pattern was observed on most US recessions since the 1960's, the 2008 being a remarkable example of this leveraging process.
...
This negative relation is corroborated by comparing the correlation between GDP and the net lending of households (NL_HH and NLa_HH), and business (NL_PVT, NLa_PVT), as we can see below:
